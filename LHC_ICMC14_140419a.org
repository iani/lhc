...
The output produced by our initial device (2012) presents some readily recognizeable interesting characteristics.  The difference of phase between the rate of the counter and the variable rate of the sampling of the
